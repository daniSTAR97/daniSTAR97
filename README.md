# Hi, I'm Daniel Daystar 👋

I'm a data analyst and ICT educator based in Lagos, Nigeria.
I work with Power BI, Excel, and Power Query to turn raw data
into dashboards and insights that help businesses make better decisions.
Currently building my analytics portfolio and pursuing a degree in
...
![Power Query](https://img.shields.io/badge/Power%20Query-2E75B6?style=for-the-badge&logo=microsoft&logoColor=white)
...
`Power BI` `DAX` `Star Schema` `Power Query` `Multi-page Dashboard`
...
`Power BI` `DAX` `Time Intelligence` `Field Parameters` `Bookmarks`
...
`Power BI` `Power Query` `DAX` `Data Modelling` `Public Safety`
...
`Power BI` `Power Query` `Data Visualisation` `Retail Analytics`

---

## 📫 Let's Connect

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/www.linkedin.com/in/daniel-daystar-5135b0322)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:danny300897@gmail.com)
